...
// Function to toggle instructions visibility and save state
function toggleInstructions() {
    let instructions = document.getElementById("instructions");
    let toggleButton = document.getElementById("toggleInstructions");

    let isHidden = instructions.classList.contains("hidden");
    instructions.classList.toggle("hidden");
    toggleButton.textContent = isHidden ? "Hide Instructions" : "Show Instructions";

    // Save the state in localStorage
    localStorage.setItem("instructionsHidden", isHidden ? "false" : "true");
}

// Function to load instructions state from localStorage
